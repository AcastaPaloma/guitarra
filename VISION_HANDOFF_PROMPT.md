...
> and operator authority in [AGENTS.md](AGENTS.md). **Guitar camera input is off by default**;
> this archived lamp prompt is not permission to enable it. The original prompt body is preserved.
